...
* *Utilize the provided CRUD storage API as the data tier* for the Event API backend. (Documentation Below)
* Events should not overlap.
* The schedule should span across 3 days.
* Authenticate the Admin View to Event API using Basic Authentication.
...
* Once you've completed the project, upload it to your github account and use the following url to submit your work:
    * [https://crud-api.azurewebsites.net]
